...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.behavior.callback.listener.ABDamageTakenListenerCallback;
...
public class ABActionAddDamageTakenListener implements ABAction {
	...
	public void runAction(final CUnit caster, final LocalDataStore localStore,
		...
		target.addDamageTakenListener(listener.callback(caster, localStore, castId));
	}
}