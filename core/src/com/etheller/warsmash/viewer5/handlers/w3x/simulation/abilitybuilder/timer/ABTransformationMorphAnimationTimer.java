...
public class ABTransformationMorphAnimationTimer extends CTimer {
	private final CUnit unit;
	private final boolean addAlternateTagAfter;

	public ABTransformationMorphAnimationTimer(final CUnit unit, final boolean addAlternateTagAfter, final float delay) {
		super();
		this.unit = unit;
