...
public class ABCallbackArgumentFX extends ABFXCallback {
	...
	@Override
	public SimulationRenderComponent callback(final CUnit caster, final LocalDataStore localStore,
			final int castId) {
		...
		if (cbck != null && cbck instanceof ABFXCallback) {
			return ((ABFXCallback) cbck).callback(caster, localStore, castId);
		} else {
