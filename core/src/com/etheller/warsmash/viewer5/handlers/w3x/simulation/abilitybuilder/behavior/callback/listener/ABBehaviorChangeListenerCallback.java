...
public abstract class ABBehaviorChangeListenerCallback implements ABCallback {

	abstract public ABBehaviorChangeListener callback(final CUnit caster, final ABLocalDataStore localStore,
			final int castId);
}
