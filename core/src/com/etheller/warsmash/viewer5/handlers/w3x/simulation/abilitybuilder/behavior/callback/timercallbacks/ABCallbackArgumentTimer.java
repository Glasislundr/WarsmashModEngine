...
public class ABCallbackArgumentTimer extends ABTimerCallback {

	private ABStringCallback name;

	@Override
	public CTimer callback(final CSimulation game, final CUnit caster,
		...
		if (cbck != null && cbck instanceof ABTimerCallback) {
			return ((ABTimerCallback) cbck).callback(game, caster, localStore, castId);
		} else {
