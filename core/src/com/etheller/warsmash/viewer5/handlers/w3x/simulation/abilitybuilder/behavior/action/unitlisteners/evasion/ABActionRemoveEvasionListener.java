...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.behavior.callback.listener.ABEvasionListenerCallback;
...
public class ABActionRemoveEvasionListener implements ABAction {
	...
	public void runAction(final CUnit caster, final LocalDataStore localStore,
		...
		target.removeEvasionListener(listener.callback(caster, localStore, castId));
	}
}