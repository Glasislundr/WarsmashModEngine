...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.behavior.callback.listener.ABAbilityEffectReactionListenerCallback;
...
public class ABActionAddAbilityEffectReactionListener implements ABAction {
	...
	public void runAction(final CUnit caster, final ABLocalDataStore localStore, final int castId) {
		...
		target.addAbilityEffectReactionListener(listener.callback(caster, localStore, castId));
	}
}