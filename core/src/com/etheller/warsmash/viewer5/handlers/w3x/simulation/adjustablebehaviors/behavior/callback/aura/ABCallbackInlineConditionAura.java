...
public class ABCallbackInlineConditionAura extends ABAuraCallback {

	private ABBooleanCallback condition;
	private ABAuraCallback pass;
	private ABAuraCallback fail;

	@Override
	public ABAuraEffect callback(CUnit caster, ABLocalDataStore localStore, int castId) {
