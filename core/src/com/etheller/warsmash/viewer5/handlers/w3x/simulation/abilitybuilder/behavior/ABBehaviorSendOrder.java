...
public class ABBehaviorSendOrder implements CBehavior {
	...
	public ABBehaviorSendOrder(final CUnit unit, CAbility ability, final int orderId, final int visibleOrderId,
	...
	public CBehavior update(CSimulation game) {
		return ability.begin(game, unit, orderId, false, target);
	}
