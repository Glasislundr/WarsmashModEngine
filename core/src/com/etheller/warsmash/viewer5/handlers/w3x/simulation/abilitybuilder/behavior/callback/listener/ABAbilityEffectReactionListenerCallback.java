...
public abstract class ABAbilityEffectReactionListenerCallback implements ABCallback {

	abstract public ABAbilityEffectReactionListener callback(final CUnit caster, final ABLocalDataStore localStore,
			final int castId);
}
