...
public class ABConditionIsLocationShallowWater extends ABCondition {
	...
	public Boolean callback(CSimulation game, CUnit caster, LocalDataStore localStore, final int castId) {
		...
		return game.getPathingGrid().isPathable(loc.x, loc.y, PathingType.SWIMMABLE)
				&& game.getPathingGrid().isPathable(loc.x, loc.y, PathingType.WALKABLE);
	}
