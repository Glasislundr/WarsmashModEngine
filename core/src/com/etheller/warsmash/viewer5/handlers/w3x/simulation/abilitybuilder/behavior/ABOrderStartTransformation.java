...
public class ABOrderStartTransformation extends COrderNoTarget {
	private CBehavior transformBehavior;

	public ABOrderStartTransformation(final CBehavior transformBehavior, final int orderId) {
	...
	public boolean equals(final Object obj) {
		...
		final ABOrderStartTransformation other = (ABOrderStartTransformation) obj;
