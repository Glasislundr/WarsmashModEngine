...
public class ABCallbackReuseAbilityWithArguments extends ABAbilityCallback {

	private ABStringCallback name;
	private Map<String, ABCallback> arguments;

	@Override
	public CAbility callback(final CUnit caster, final ABLocalDataStore localStore,
			final int castId) {
