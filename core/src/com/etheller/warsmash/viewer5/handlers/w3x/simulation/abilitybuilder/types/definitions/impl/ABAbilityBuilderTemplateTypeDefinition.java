...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.types.impl.ABAbilityBuilderTemplateType;
...
public class ABAbilityBuilderTemplateTypeDefinition
	...
	protected CAbilityType<?> innerCreateAbilityType(final War3ID alias, final GameObject abilityEditorData,
		...
		if (abilityEditorData != null) {
			return new ABAbilityBuilderTemplateType(alias, abilityEditorData.getFieldAsWar3ID(CODE, -1), abilityEditorData, levelData, parser);
		} else {
			return new ABAbilityBuilderTemplateType(alias, alias, null, null, parser);
		}
	}
