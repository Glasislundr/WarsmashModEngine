...
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.parser.ABAbilityBuilderParserUtil.AbilityBuilderFileListener;
import com.etheller.warsmash.viewer5.handlers.w3x.simulation.abilitybuilder.parser.ABAbilityBuilderType;
import com.google.gson.Gson;

public class AbilityBuilderSmashJassBrainstorm {
...
//					idsListModel.addElement(new AbilityBuilderConfiguration(behavior, dupe));
	...
	private static void generateJassForConf(final ABAbilityBuilderDupe dupe,
		...
		final StringBuilder structCode = new StringBuilder();
		...
		if (type != null) {
			...
			throw new IllegalStateException("no abconf type");
		}
